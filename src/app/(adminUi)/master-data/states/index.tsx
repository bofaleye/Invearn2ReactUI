...
import { useFetchStatesQuery, useDeleteStatesTypeMutation } from "./statesApiSlice";
...
const tableExportFileName = "states";
...
export default function States(): React.ReactElement {
  ...
  const { data, refetch, isFetching } = useFetchStatesQuery();
  const [deleteBank, { isLoading, isSuccess, isError, error }] = useDeleteStatesTypeMutation();
  ...
  const entityNameSingular = "States";
  ...
  if(isSuccess){
    ...
    GpToast({ type: 'success', message: "State deleted successfully",
    ...
    <div className="px-8 pt-6 pb-10">
      <div className="mb-4">
        <Breadcrumb aria-label="Default breadcrumb example">
          ...
          <Breadcrumb.Item>States</Breadcrumb.Item>
        </Breadcrumb>
      </div>
      {/* <SuccessModal /> */}

...
export default function Dashboard() {
  ...
  let initialSeries: ApexAxisChartSeries | ApexNonAxisChartSeries = [
    {
      name: "Revenue",
  ...
  // State
  const [apexchartSeries, setApexChartSerires] = React.useState(initialSeries);
          ...
          <form className="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
            ...
            <article className="mb-5">
              ...
              <p className="mb-2 text-gray-900 dark:text-white">
                ...
                review everything. I'am looking forward to the next steps! Thank
                you.`}
              </p>
              <p className="mb-3 text-gray-900 dark:text-white">
                Looking forward to it! Thanks.
            ...
            <div className="relative mx-auto overflow-hidden h-[36rem] lg:h-[24rem]">
              ...
              >
                ...
                <p className="mb-4 text-gray-500 dark:text-gray-400">
                  ...
                  built with Tailwind CSS and Flowbite featuring charts,
                  widgets, CRUD layouts, authentication pages, and more
                </p>
                ...
                <ul className="pl-4 mb-4 space-y-3 text-gray-500 list-disc dark:text-gray-400">
                  <li>
                    What are the new challenges in the delivery industry due to

...
const DashboardLayoutSidebar: React.FC<DashboardLayoutSidebarProps> = ({ mobile = false })=>{
    ...
    return(
        ...
        <aside
          id="sidebar"
          className={`fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 w-64 h-full font-normal duration-75 lg:flex transition-width ${mobile ? mobileClass : defaultClass}`}
          aria-label="Sidebar"
        >
              ...
              <div className="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul className="pb-2 space-y-2">
                  ...
                  <li>
                    <Link
                      href="/"
                      className={`flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 ${isActiveRoute('') && activeClass}`}
                    >
                      <svg
                  ...
                  <li>
                    <button
                      ...
                      aria-controls={`dropdown-layouts-${tag}`}
                      data-collapse-toggle={`dropdown-layouts-${tag}`}
                    >
                      <svg
                    ...
                    <ul id={`dropdown-layouts-${tag}`} className="hidden py-2 space-y-2">
                      <li>
                        <a
                          href=""
                  ...
                  <li>
                    <button
                      type="button"
                      className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                      aria-controls={`dropdown-crud-${tag}`}
                      data-collapse-toggle={`dropdown-crud-${tag}`}
                      aria-expanded="false"
                    >
                      <svg
                        className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                    ...
                    <ul id={`dropdown-crud-${tag}`} className="space-y-2 py-2 hidden">
                      <li>
                        <a
                          href=""
                  ...
                  <li>
                    <Link
                      href="/settings"
                      className={`flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 ${isActiveRoute('settings') && activeClass}`}
                    >
                      <svg
                        className="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                        fill="currentColor"
                  ...
                  <li>
                    <button
                      type="button"
                      className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                      aria-controls={`dropdown-pages-${tag}`}
                      data-collapse-toggle={`dropdown-pages-${tag}`}
                    >
                      <svg
                        className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                        fill="currentColor"
                    ...
                    <ul id={`dropdown-pages-${tag}`} className="hidden py-2 space-y-2">
                      <li>
                        <a
                          href=""
                          className="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                  ...
                  <li>
                    <button
                      type="button"
                      className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                      aria-controls={`dropdown-auth-${tag}`}
                      data-collapse-toggle={`dropdown-auth-${tag}`}
                    >
                      <svg
                        className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                        fill="currentColor"
                    ...
                    <ul id={`dropdown-auth-${tag}`} className="hidden py-2 space-y-2">
                      <li>
                        <a
                          href=""
                          className="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                  ...
                  <li>
                    <button
                      type="button"
                      className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                      aria-controls={`dropdown-playground-${tag}`}
                      data-collapse-toggle={`dropdown-playground-${tag}`}
                      aria-expanded="false"
                    >
                      <svg
                        className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                    ...
                    <ul id={`dropdown-playground-${tag}`} className="space-y-2 py-2 hidden">
                      <li>
                        <a
                          href=""
                          className="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"
